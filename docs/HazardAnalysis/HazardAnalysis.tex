...
\begin{itemize}
    ...
    \begin{itemize}
        ...
        \item The authentication module will handle the user login through unique username and password. The module will prevent access to person health information, and treatment progress record. Some sample hazards that may occur are: data information leaks resulting to account compromise and unauthorized access to medical data. 
    \end{itemize}
