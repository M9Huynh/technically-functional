...
This module enables the creation of an account in the user database. This database consists of the following tables:\\
\begin{enumerate}
...
This module's purpose is to handle all of the users' accounts in the user database.
