...
\multicolumn{3}{|>{\columncolor{lightblue}}p{15cm}|}{\textbf{CreatePatient:} Physiotherapist registration screen component.} \\
\hline
\rowcolor{white}
\texttt{props: none} &
\texttt{JSX.Element} - Renders physiotherapist registration form with validation &
...
\multicolumn{3}{|>{\columncolor{lightblue}}p{15cm}|}{\textbf{CreatePhysio:} Physiotherapist registration screen component.} \\
\hline
\rowcolor{white}
\texttt{props: none} &
\texttt{JSX.Element} - Renders physiotherapist registration form with validation &
...
\multicolumn{3}{|>{\columncolor{lightblue}}p{15cm}|}{\textbf{validatePasswordlength():} Internal helper function for password validation.} \\
\hline
\rowcolor{white}
...
\multicolumn{3}{|>{\columncolor{lightblue}}p{15cm}|}{\textbf{validateBirthday():} Internal helper function for birthday format validation.} \\
\hline
\rowcolor{white}
