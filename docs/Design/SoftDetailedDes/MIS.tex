...
This module enables the creation of an account in the user database. 
It uses a database to store any information that is essential for other modules to perform their
actions. A database was used for its ease of manipulation and its comprehensive, multi-functional nature. \\
...
\end{enumerate}  
The module results in the creation of a single instance of one of the objects listed below:\\
\begin{itemize}
