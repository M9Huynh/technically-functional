...
\underline{\textbf{\textit{create-patient.tsx}}}
\begin{description}[style=nextline, leftmargin=2.5cm]
\item[\texttt{const router = useRouter();}] 
    Expo Router instance for programmatic navigation after form submission. Imported from \texttt{expo-router}.
...
\item[\texttt{const [licenseNumber, setLicenseNumber] = useState("");}] 
    Manages the professional license number input field; initializes as empty string. Required for physiotherapist verification.
