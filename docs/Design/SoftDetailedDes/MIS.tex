...
\hline
\rowcolor{white}
record\_check & \makecell[lt]{\textit{starting\_frane}} & \makecell[lt]{\textit{good\_to\_record}} & \makecell[lt]{UserNotFound\\Error\\DownloadError} \\
\hline
...
\end{tabular}
\caption{Video Processing Access Routines}
