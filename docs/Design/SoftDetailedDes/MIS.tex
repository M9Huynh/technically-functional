...
\hline
\rowcolor{white}
invite\_code\_check & \makecell[lt]{\textit{name}\\\textit{invite\_code}} & \textit{is\_valid} & \makecell[lt]{FieldEmptyError\\InvalidCredsError} \\
\hline
...
\noindent \textbf{State Invariant} \\
$\forall$ $license\_b \in \mathbb{Z}^{+},$ $\forall$ $license\_d \in \mathbb{Z}^{+}:$ $license\_b \neq license\_d$ \\
$\forall$ $invite\_a \in \mathbb{Z}^{+},$ $\forall$ $invite\_c \in \mathbb{Z}^{+}:$ $invite\_a \neq invite\_c$ \\
