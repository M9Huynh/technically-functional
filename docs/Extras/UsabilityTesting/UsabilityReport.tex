...
\section{Techniques}
The techniques used to conduct these tests were a mixture of both in-person and remote moderated testing. The mode employed
was a questionnaire or an interview. This decision was up to the moderator. 
