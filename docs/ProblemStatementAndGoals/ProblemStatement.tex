...
The extras chosen for the project are a \textbf{Design Thinking Document} and \textbf{User Instructional Video}.

The Design Thinking Document will explain how we approached our project from a higher level perspective.

The User Instructional Video will be a demonstration on the use of our application, to serve as a guide to new users and a demonstration to instructors alike.
