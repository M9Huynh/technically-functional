...
\midrule
September 16th, 2025 & Maham & Added initial content to 1.3\\
...
depends heavily on the individual performing the exercise correctly. In turn, this creates a need for a tool that helps users 
adjust their exercise form without supervision. This project aims to develop a tool that can 
provide feedback and correction during the prescribed exercises.
