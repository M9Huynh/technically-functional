...
September 26 -27, 2025 & Maham & Resolved and addressed issues\\
March 14, 2026 & Matthew & Fixed the TA comments and revised the document.\\
...
According to the Global Burden of Diseases, Injuries and Risk Factors study performed in 2019, individuals that would benefit from physical rehabilitation at least once in their lifetime is upwards of 2.41 billion globally \citep{CiezaEtAl2021}. Those with access to a physiotherapist experienced a disconnect with performing a required movement with proper time-under-tension (TUT) and correct form \citep{FaberEtAl2015}. While a physiotherapist can advise these individuals during their assessments and proceeding follow-up appointments, the efficacy of rehabilitation depends heavily on the individual's correct performance of the exercise. In turn, this creates a need for a tool that can ensure users correctly perform the exercise without supervision. This project aims to develop a tool that can provide feedback and corrections for the prescribed physical rehabilitation exercise.

\subsection{Inputs and Outputs}

\textbf{Inputs:} A recording of the user performing their physical rehabilitation exercise, captured through a smartphone with a video recording ability. \\
...
\subsection{Stakeholders}
  \subsubsection{Primary Stakeholders}
    ...
    plan which outlines the exercise selected by the team. The application will be providing additional correction of the patient's form and feedback on their performance to ensure safety and maximal efficacy of the physiotherapist prescribed exercise without the need for constant monitoring. 
...
\subsection{Environment}
  \subsubsection{Software}
    The application will be built using an object oriented programming language with supplementary libraries to enable the use of computer vision technology, authentication services and data storage.
  \subsubsection{Hardware}
    The application will be designed for IOS or Android operating systems and will run on an smartphone with a camera recording ability. Any further development for different operating systems is out of scope for this project. 
    
\section{Goals}

\begin{enumerate}
  \item \textbf{Support Physiotherapy Patients in Recovery}: Help patient perform prescribed physiotherapy exercises at home between physiotherapy sessions by providing a tool that tracks exercise completion. The application will track how frequently exercises are completed over time as well as the physiotherapist's guidelines on the application. This can be measured by comparing the number of required exercise sessions and total repetitions done between sessions assigned by the physiotherapist.

  \item \textbf{Promote Safe and Correct Exercise Practice}: Assist patients to maintain proper form and technique during rehabilitation exercises, specific to their personal physiotherapy needs, to reduce the risk of re-injury and improve recovery outcomes. This can be useful to a physiotherapist with insightful information about a patient's performance and perceived exertion which can be used to modify the exercise plan when needed. This can be measured by the frequency of corrections needed and the number of times the patient is performing the exercise with correct form.
  ...
  \item \textbf{Ease of Use for the Patient}: Design an application which is straightforward and user-friendly for the patient to navigate and use, particularly for those unfamiliar with technology. This app should require minimal setup and provide clear instructions for use. This can be addressed during testing by evaluating the ease of use and navigation of the application.
...
\begin{enumerate}
  \item \textbf{Expanded Exercise Library}: Support additional exercises beyond a single lower body part, covering upper-body and full-body rehab exercises.
  ...
  \item \textbf{Perceived Exertion}: Users can rate how difficult performing the exercise was on a scale of 1-10 (10 being 'extremely difficult'). A logging functionality which allows users to enter the reason for the perceived difficulty of the exercise can be added in future iterations of the application. 
...
and \textbf{Usability Report}. \\

\underline{The Design Thinking Document} will explain how we approached our project
from a higher level perspective. 

\underline{The Usability Report} will document the results of user testing and the feedback received from users. This will include the design of the testing, the results and the discussion of the results.
