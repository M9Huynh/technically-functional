...
\textbf{Test Case ID} & \textbf{System\_rejects\_duplicate} \\
\hline
Control & Automatic \\
\hline
...
\begin{itemize}
    \setlength\itemsep{0em}
    \item User attempts to create account with existing email/login ID
    \item System checks database for duplicates
    \item System displays error message and prevents account creation
    \item Verify existing accounts remain unaffected
\end{itemize} \\
\hline
