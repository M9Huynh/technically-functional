...
\end{enumerate}
\textbf{Note: Automatic tests will be run using a script. This script will contain tests for valid, invalid and edge cases. See Appendix (?) for an example template.
